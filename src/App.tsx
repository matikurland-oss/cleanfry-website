      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-right">
          ...
          <div className="space-y-2">
            ...
            <FAQItem 
  question="איפה קונים אבקה למיצוק שמן בישול?" 
  answer="ניתן להזמין את CleanFry ישירות כאן באתר! אנחנו מציעים משלוחים מהירים לכל הארץ ומשלוח חינם ברכישה מעל 249 ש״ח." 
/>
          </div>
        </div>
      </section>
